...
const QString BITCOIN_IPC_PREFIX("ilscoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/ilscoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/ilscoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/ilscoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click ilscoin: links
...
//
// OSX-specific way of handling ilscoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in ilscoin: URIs
