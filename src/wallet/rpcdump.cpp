...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"ilscoinaddress\"\n"
            "\nReveals the private key corresponding to 'ilscoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"ilscoinaddress\"   (string, required) The ilscoin address for the private key\n"
            "\nResult:\n"
