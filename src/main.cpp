...
#if defined(NDEBUG)
# error "ILSCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "ILSCoin Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // ILSCoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // ILSCoin also requires low S in sigs
