...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ilscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ilscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ilscoin transaction") + "\n" +
              "  ilscoin-tx [options] -create [commands]   " + _("Create hex-encoded ilscoin transaction") + "\n" +
              "\n";
