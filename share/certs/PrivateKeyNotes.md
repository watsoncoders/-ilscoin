...
unlocked to sign the ILSCoin-Qt.app bundle.
...
allowing somebody to distribute a ILSCoin-Qt.app or ilscoin-qt-setup.exe with a valid
...
that the ilscoin-qt.exe file inside the installer had not been tampered with.
