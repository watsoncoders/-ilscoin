...
These are the dependencies currently used by ILSCoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/ilscoinnl
Keybase  - https://keybase.io/team/ilscoin/
